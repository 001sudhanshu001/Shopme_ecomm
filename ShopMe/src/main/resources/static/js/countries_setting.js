...
function deleteCountry() {
    ...
    $.get(url,function(){
        ...
        showToastMessage("All countires have been Deleted");
    }).fail(function(){
        showToastMessage("ERROR : Could not connect to Server or Server encounterd error");
    });
}
...
function loadConutries() {
    ...
    $.get(url,function(responseJSON){
        ...
        showToastMessage("All countires have been loaded");
    }).fail(function(){
        showToastMessage("ERROR : Could not connect to Server or Server encounterd error");
    });
}
